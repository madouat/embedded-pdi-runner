package bf.associateconsultant.core.listener;
 ...
 * @author tomqin
 */
public class StepRowListener implements RowListener {
	private transient final Log log = LogFactory.getLog(StepRowListener.class);
	private List<RowMetaAndData> rowsRead;
	private List<RowMetaAndData> rowsWritten;
	private List<RowMetaAndData> rowsError;

	public StepRowListener() {
